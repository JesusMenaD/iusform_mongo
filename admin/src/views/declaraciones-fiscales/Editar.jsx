...
const EditarDeclaraciones = ({ usuarioC = null }) => {
  ...
  useEffect(() => {
    const getDeclaracionFiscal = async () => {
      const url = `/declaraciones-fiscales/${_id}/by-id`

      const { data } = await apiAuth().get(url)
      setNombre(data.declaracion.nombre)
      setTipo(data.declaracion.tipo)
      setEstatus(data.declaracion.estatus)
    }
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const url = `/declaraciones-fiscales/${_id}`
...
export default memo(EditarDeclaraciones)
