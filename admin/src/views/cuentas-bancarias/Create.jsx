...
const title = 'Crear cuenta bancaria'
const sx = { mb: 4 }

const CreateCuentaBancaria = ({ usuarioC = null }) => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const url = `/cuentas-bancarias/${despacho}`
          ...
          >
            ...
            <TextField
              ...
              InputProps={{
                ...
                // Este es un ejemplo para mostrar el valor formateado, ajusta según necesites
...
export default memo(CreateCuentaBancaria)
